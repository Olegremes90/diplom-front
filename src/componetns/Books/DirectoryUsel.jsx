...
const DirectoryUsel = () => {
    ...
    useEffect(()=>{
        ...
        const lead_list = await axios.get(`http://127.0.0.1:8000/api/usel-detail/${params.title}`, {headers}).
            then((result)=>{
    ...
    const AddUsel=(e)=>{
        ...
        axios.post(`http://127.0.0.1:8000/api/usel/add/`, state, {headers}).then((result)=>{
            console.log(result)
