...
const DirectoryTechnic = () => {
    ...
    useEffect(()=>{
         const getTechnic = async()=>{
            ...
            const technic_list = await axios.get(`http://127.0.0.1:8000//technica-detail/${params.title}/`, {headers}).
                then((result)=>{
    ...
    const AddTechnica=(e)=>{
        ...
        axios.post(`http://127.0.0.1:8000//technic/add/`, state, {headers}).then((result)=>{
            console.log(result)
     ...
     const UpdateTechnic= async(e)=>{
        ...
        const state = {
         ...
         const serv = await axios.patch(`http://127.0.0.1:8000//update-technica/${technic[0].id}`, state, {headers}).then((result)=>{
